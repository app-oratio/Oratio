---
title: São Roque
short_title: São Roque
slug: sao-roque
subtitle: Peregrino e servidor dos enfermos
description: São Roque é venerado como peregrino que cuidou das vítimas de epidemias e confiou em Deus quando ele próprio adoeceu e foi abandonado.
entry_type: Santo
...
daily_order: 10
featured: false
image: /assets/images/saints/sao-roque.webp
image_alt: Imagem horizontal representando São Roque
image_width: 1200
image_height: 675
...
summary: A tradição apresenta Roque como um jovem de Montpellier que distribuiu seus bens, peregrinou a Roma e cuidou de vítimas da peste. Ao adoecer, retirou-se para não contaminar outros e experimentou a Providência em meio ao abandono.
prayer: São Roque, amigo dos enfermos e peregrino de Deus, intercedei por todos os que sofrem doenças e por aqueles que os assistem. Alcançai-nos compaixão, prudência e confiança na Providência, especialmente nos tempos de epidemia e medo. Amém.
related_saints:
...
related: []
sources:
- title: 'Templário de Maria: São Roque'
...
- label: Padroeiro de
  ...
  - Doentes
  - Peregrinos
  - Proteção contra epidemias
  wide: true
timeline:
- date: Séculos XIII–XIV, segundo a tradição
  title: Nascimento em Montpellier
  description: Roque teria nascido numa família rica e escolhido a vida de peregrino.
- date: Juventude
  title: Peregrinação a Roma
  description: Distribui os bens e parte pelos caminhos da Europa.
- date: Durante as epidemias
  title: Serviço aos doentes
  description: Detém-se em cidades atingidas pela peste para cuidar dos enfermos.
- date: Segundo a tradição
  title: Doença e isolamento
  description: Contaminado, retira-se para não transmitir a enfermidade e recebe auxílio providencial.
- date: Século XV
  title: Difusão do culto
  description: Sua veneração cresce especialmente entre populações ameaçadas por epidemias.
---
