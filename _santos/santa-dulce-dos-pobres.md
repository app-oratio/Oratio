...
short_title: Santa Dulce dos Pobres
slug: santa-dulce-dos-pobres
subtitle: Religiosa e servidora dos pobres e enfermos
description: Santa Dulce dos Pobres fez da caridade uma obra concreta e duradoura, acolhendo quem não encontrava lugar nos hospitais e na sociedade.
entry_type: Santa
subject_schema_type: Person
liturgical_rank: Memória
category: Santos do Brasil
liturgical_date:
  type: fixed
  month: 8
  day: 13
...
daily_order: 20
featured: false
image: /assets/images/saints/santa-dulce-dos-pobres.webp
image_alt: Imagem horizontal representando Santa Dulce dos Pobres
image_width: 1200
image_height: 675
...
summary: Nascida em Salvador, Maria Rita percebeu ainda adolescente que não conseguiria fechar a porta aos pobres e doentes. Como Irmã Dulce, transformou iniciativas improvisadas numa grande obra de saúde e assistência, sem perder a simplicidade de quem via Jesus em cada pessoa acolhida.
prayer: Santa Dulce dos Pobres, ajudai-nos a enxergar Cristo naqueles que sofrem e a não fechar a porta diante da necessidade. Intercedei pelos doentes, pelos pobres, pelos profissionais da saúde e por todos os que sustentam obras de misericórdia. Amém.
related_saints:
- sao-roque
- santa-rosa-de-lima
...
related: []
sources:
- title: 'Templário de Maria: Santa Dulce dos Pobres'
...
timeline:
- date: '1914'
  title: Nascimento em Salvador
  description: Maria Rita nasce na Bahia e desde jovem demonstra sensibilidade diante da pobreza.
- date: '1933'
  title: Entrada na vida religiosa
  description: Recebe o nome de Irmã Dulce nas Missionárias da Imaculada Conceição.
- date: '1949'
  title: O galinheiro se torna abrigo
  description: Com autorização, acolhe dezenas de enfermos num espaço ao lado do convento.
- date: '1992'
  title: Morte
  description: A religiosa morre depois de uma vida inteiramente dedicada aos necessitados.
- date: '2011'
  title: Beatificação
  description: A Igreja reconhece oficialmente suas virtudes e um milagre atribuído à sua intercessão.
- date: '2019'
  title: Canonização
  description: O papa Francisco proclama Santa Dulce dos Pobres.
---
