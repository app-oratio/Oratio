---
title: Dia 9 — Novena pelas Almas do Purgatório
devotion: novena-pelas-almas-do-purgatorio
day: 9
description: São grandes todas as penas que sofrem as almas no Purgatório; o fogo, o tédio, a escuridão, a incerteza do tempo em que hão de ver-se livres de todos estes tormentos; mas a maior de todas é o verem-se separadas do seu…
permalink: /novenas/novena-pelas-almas-do-purgatorio/dia-9/
default_language: pt
...
- id: secao-01-oracoes
  ...
  - id: oracao-010-proposito
    label: Propósito
    prayer: Formemos uma firme resolução de oferecer todas as nossas obras satisfatórias em sufrágio das necessitadas almas do Purgatório.
    language_toggle: false
  ...
  - id: oracao-015-oracao
    ...
    language_toggle: false
  - id: oracao-016-oracao-as-benditas-almas-livres-do-purgatorio-pe
    label: Oração às benditas almas, livres do purgatório pelos nossos sufrágios.
    prayer: |-
