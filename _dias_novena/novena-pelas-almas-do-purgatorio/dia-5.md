---
title: Dia 5 — Novena pelas Almas do Purgatório
devotion: novena-pelas-almas-do-purgatorio
day: 5
description: Outra pena que tortura horrivelmente as benditas almas do Purgatório é o terem de sofrer os ardores de um fogo abrasador sem saber quando terão fim os seus tormentos.
permalink: /novenas/novena-pelas-almas-do-purgatorio/dia-5/
default_language: pt
...
- id: secao-01-oracoes
  ...
  - id: oracao-009-ave-maria
    ...
    language_toggle: false
    count: 5
  - id: oracao-010-proposito
    label: Propósito
    prayer: Não comer nada fora das horas costumadas, ou fazer alguma mortificação corporal em sufrágio das almas do Purgatório.
    language_toggle: false
  - id: oracao-011-oracoes-finais
    label: Orações finais
    prayer: Encomendamos agora a Jesus Cristo e à sua Santíssima Mãe todas as almas do Purgatório e, em especial, as dos nossos parentes, benfeitores, amigos e inimigos e, sobretudo, as daqueles por quem temos obrigação de pedir.
    language_toggle: false
  - id: oracao-012-novena-pelas-almas-do-purgatorio
    label: Novena pelas Almas do Purgatório
    prayer: |-
    ...
    language_toggle: false
  - id: oracao-013-novena-pelas-almas-do-purgatorio
    label: Novena pelas Almas do Purgatório
    prayer: |-
    ...
    language_toggle: false
  - id: oracao-014-novena-pelas-almas-do-purgatorio
    label: Novena pelas Almas do Purgatório
    prayer: |-
