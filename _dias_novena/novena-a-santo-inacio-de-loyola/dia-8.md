---
title: Dia 8 — Novena a Santo Inácio de Loyola
devotion: novena-a-santo-inacio-de-loyola
day: 8
description: Catequista de crianças, de jovens e do povo simples, protetor dos humildes e desamparados, Inácio fez sua “opção pelos pobres”, porque sabia encontrar em cada ser humano o rosto de Jesus Cristo.
permalink: /novenas/novena-a-santo-inacio-de-loyola/dia-8/
default_language: pt
...
- id: secao-01-oracoes
  title: Orações
  prayers:
  - id: oracao-001-oracao-introdutoria
  ...
  - id: oracao-004-oracao-inicial
    ...
    prayer: |-
      Senhor, amparados em vossa força e proteção queremos assumir nosso compromisso com o Evangelho e os irmãos e irmãs de caminhada, conscientes de que um mundo mais justo, fraterno e cristão depende um pouco de cada um de nós. Sob as bênçãos de Nossa Senhora e pela intercessão de Santo Inácio de Loyola, concedei-nos a graça, que humildemente vos pedimos… (peça a graça).
      Por Cristo Senhor Nosso.
      Amém.
    language_toggle: false
  - id: oracao-005-responsorio-breve
    label: Responsório Breve
    prayer: |-
      R. Deus nos conceda o conhecimento íntimo do Senhor, que por nós Se fez homem.
      V. Para O amarmos e seguirmos fielmente.

      R. Deus nos encha de esperança, fé e caridade, consolação e alegria interior.
      V. Para O amarmos e seguirmos fielmente.
    language_toggle: false
