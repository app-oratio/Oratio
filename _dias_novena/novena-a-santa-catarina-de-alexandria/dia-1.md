---
title: Dia 1 — Novena a Santa Catarina de Alexandria
devotion: novena-a-santa-catarina-de-alexandria
day: 1
description: Consideremos que sendo Catarina nascida de nobres pais em Alexandria, foi educada nas artes liberais que ilustram o entendimento e na santa doutrina cristã, aprendendo a fundamento fundo as provas da religião.
permalink: /novenas/novena-a-santa-catarina-de-alexandria/dia-1/
default_language: pt
...
- id: secao-01-oracoes
  ...
  - id: oracao-005-gloria-ao-pai
    ...
    language_toggle: false
    count: 3
  - id: oracao-006-novena-a-santa-catarina-de-alexandria
    label: Novena a Santa Catarina de Alexandria
    prayer: |-
      V. Santa Catarina, mestra dos doutores.

      R. Rogai por todos os pecadores.
    language_toggle: false
  - id: oracao-007-novena-a-santa-catarina-de-alexandria
    label: Novena a Santa Catarina de Alexandria
    prayer: |-
