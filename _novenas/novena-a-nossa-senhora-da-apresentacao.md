---
title: Novena a Nossa Senhora da Apresentação
slug: novena-a-nossa-senhora-da-apresentacao
description: O título de Nossa Senhora da Apresentação surgiu de uma Tradição cristã muito antiga que narra a apresentação de Maria, feita por seus pais, Joaquim e Ana, no templo de Jerusalém.
category: Novenas marianas
image: /assets/images/novenas/novena-a-nossa-senhora-da-apresentacao.png
image_alt: Novena a Nossa Senhora da Apresentação
search: true
days: 9
calendar:
  base_month: 11
